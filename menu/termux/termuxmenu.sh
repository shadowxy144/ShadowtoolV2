...
pkg install nmap -y && pkg install cloudflare -y && pkg install python -y && pkg install whois
...
nmap -sS -O "$ip2" | tee "$anadizin/menu/logs/nmaplog.txt"
...
nmap -sS -O -sV "$ip3" | tee "$anadizin/menu/logs/nmaplogs.txt" 
